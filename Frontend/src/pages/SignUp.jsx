    ...
    return (
        ...
        <div className = {`bg-white rounded-xl shadow-lg w-full max-w-md p-8 border`} style = {{
            ...
            <div className='mb-4'>
                ...
                <input type='tel' className='w-full border rounded-lg px-3 py-2 focus:outline-none' placeholder='Enter your Mobile Number' style={{border: `1px solid ${borderColor}`}} onChange={(e)=>setMobile(e.target.value)} value={mobile} required></input>
            </div>
            ...
            <div className='mb-4'>
                ...
                <div className='relative flex gap-2'>
                    {["User", "Owner", "DeliveryBoy"].map((r) => (
                        <button key={r} type="button" className='flex-1 border rounded-lg px-8 py-2  text-center cursor-pointer font-medium transition-colors' onClick={()=>setRole(r)}
                        style = {
                            role === r
            ...
            <p className='text-center mt-4 cursor-pointer' onClick={()=>navigate("/signin")}>Already have an account ? <span className='text-[#ff4d2d]'>
                Sign In
            </span></p>
        </div>
        </div>
