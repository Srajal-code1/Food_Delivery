...
function Nav() {
  ...
  return (
    <div className="w-full h-20 flex items-center justify-between md:justify-center gap-7.5 px-5 fixed top-0 z-999 bg-[#fff9f6] overflow-visible">
      {showSearch && (
      ...
      <div className="flex items-center gap-4">
        ...
        {userData && (
          <>
            ...
            {showInfo && (
              <div className="fixed top-20 right-2.5 md:right-[10%] lg:right-[25%] w-45 bg-white shadow-2xl rounded-xl p-5 flex flex-col gap-2.5 z-999">
